...
import com.ahani.ssm.domain.Member;
...
public interface IOrdersDao {
    ...
    @Results({
            ...
            @Result(property = "product", column = "productId", javaType = Product.class, one = @One(select = "com.ahani.ssm.dao.IProductDao.findById"))
    })
